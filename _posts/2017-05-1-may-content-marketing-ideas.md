...
<div style="text-align: justify">
    ...
    <div style="-webkit-user-select:none; -khtml-user-select:none; -moz-user-select:none; -ms-user-select:none; -o-user-select:none; user-select:none;">
        <span>
        ...
        <div id="subscribe_modal">
            <form action="http://www.spiral.media/sendmail_subscription/" method="POST">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6"><button class="btn btn-action">SUBSCRIBE FOR FULL CALENDAR</button></div>
                </div>
                <input type="hidden" name="url" value="{{ site.production_url }}/files/MayCalendar.pdf">
                <input type="hidden" name="title" value="May Content Marketing Calendar">
